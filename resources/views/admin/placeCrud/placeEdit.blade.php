                ...
                <div class="modal-body">
                    ...
                    @foreach($place[0]->place_translates as $plac )
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="title_input">{{$plac->language->translation}}_Title</label>
                            <div class="col-sm-12">

                                <input type="text" name="title[{{$plac->language->id}}]" class="form-control" id="title_input" value="{{$plac->title}}">
                    ...
                    @foreach($place[0]->place_translates as $plac )
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="title_input">{{$plac->language->translation}}_Description</label>
                            <div class="col-sm-12">
                                <textarea class="form-control" name="description[{{$plac->language->id}}]" rows="5" id="comment">
                                    {{$plac->description}}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name='stateOption' id="sel1">
                                ...
                                @foreach($stats as $state)
                                    <option id="state[{{$state->id}}]" value="{{ $state->id }}">{{$state->state_translates[0]->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row center-block">
                                @foreach($place[0]->images as $imageAll)
                                    <input type="file" class="col-md-4 center-block" name="image_{{$imageAll->type}}[{{$imageAll->id}}]" id="image{{$loop->iteration }}" >
